 <nav>
  <div class="nav-wrapper grey darken-4">
    <a href="{$SITE_PATH}" class="brand-logo"><img class="logo" src="{$SITE_PATH}/img/logo_wh.png" /></a>
    ...
    <ul class="right hide-on-med-and-down">
      ...
      <li>
        <a id="lanBtn" class="f_lan_drop_down dropdown-button" href="javascript:void(0);" data-activates="dropdown1">{$ns.lm->getPhrase(20)}<i class="material-icons right">arrow_drop_down</i></a>
        <ul id="dropdown1" class="dropdown-content">
          <li><a href="{$SITE_PATH}/lang/am" class="f_cur_lan">{$ns.lm->getPhrase(31)}</a></li>
          <li class="divider"></li>
          <li><a href="{$SITE_PATH}/lang/en" class="f_cur_lan">{$ns.lm->getPhrase(32)}</a></li>
          <li class="divider"></li>
          <li><a href="{$SITE_PATH}/lang/ru" class="f_cur_lan">{$ns.lm->getPhrase(33)}</a></li>
        </ul>
      </li>
    </ul>
