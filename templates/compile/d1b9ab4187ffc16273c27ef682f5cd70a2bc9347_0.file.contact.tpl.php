<?php /* Smarty version 3.1.27, created on 2015-11-29 13:57:14
         compiled from "D:\xampp\htdocs\hqv\templates\main\contact.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:22759565acbfa384653_75232541%%*/
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '22759565acbfa384653_75232541',
  'variables' => 
  array (
    'ns' => 0,
    'SITE_PATH' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_565acbfa3b8d01_32879563',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_565acbfa3b8d01_32879563')) {
function content_565acbfa3b8d01_32879563 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '22759565acbfa384653_75232541';
?>
<div class="container">
...
/dyn/main/do_contact" method="POST">
            <div class="row">
                ...
                <div class="col s6">
                    <p><?php echo $_smarty_tpl->tpl_vars['ns']->value['lm']->getPhrase(58);?>
</p>
                    <p>
                        <a href="tel:<?php echo $_smarty_tpl->tpl_vars['ns']->value['lm']->getPhrase(59);?>
"><?php echo $_smarty_tpl->tpl_vars['ns']->value['lm']->getPhrase(59);?>
</a>,
                        <a href="tel:<?php echo $_smarty_tpl->tpl_vars['ns']->value['lm']->getPhrase(60);?>
"><?php echo $_smarty_tpl->tpl_vars['ns']->value['lm']->getPhrase(60);?>
</a>,
                        <a href="tel:<?php echo $_smarty_tpl->tpl_vars['ns']->value['lm']->getPhrase(61);?>
"><?php echo $_smarty_tpl->tpl_vars['ns']->value['lm']->getPhrase(61);?>
</a>
                    </p>
                </div>
                <div class="col s12">
