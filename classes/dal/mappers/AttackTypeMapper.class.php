...
use hqv\dal\dto\AttackTypeDto;


    class AttackTypeMapper extends AdvancedAbstractMysqlMapper {

        private static $instance;
        public $tableName = "attack_types";

        public static function getInstance() {
            if (self::$instance == null) {
                self::$instance = new AttackTypeMapper();
            }
            return self::$instance;
        }

        public function createDto() {
            return new AttackTypeDto();
        }
