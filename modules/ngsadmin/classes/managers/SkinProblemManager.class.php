...
namespace ngsadmin\managers {
  ...
  use ngsadmin\dal\mappers\SkinProblemMapper;
  use ngs\framework\AbstractManager;

  class SkinProblemManager extends AbstractManager {
    ...
    function __construct() {
      $this->mapper = SkinProblemMapper::getInstance();
    }
    ...
    public static function getInstance() {
      ...
      if (self::$instance == null) {
        self::$instance = new SkinProblemManager();
      }
    ...
    public function getSkinProblems($args=[]) {
      ...
      return $this->mapper->getSkinProblems($args);
    }
