...
namespace ngsadmin\managers {
  ...
  use ngsadmin\dal\mappers\CountryMapper;
  ...
  class CountryManager extends AbstractManager {
    ...
    function __construct() {
      $this->mapper = CountryMapper::getInstance();
    }
    ...
    public static function getInstance() {
      ...
      if (self::$instance == null) {
        self::$instance = new CountryManager();
      }
    ...
    public function getCountryInfo($args) {
      ...
      return $this->mapper->getCountryInfo($args);
    }
