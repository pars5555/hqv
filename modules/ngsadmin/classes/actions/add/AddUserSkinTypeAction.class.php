...
namespace ngsadmin\actions\add {
    ...
    class AddUserSkinTypeAction extends TableAddAbstractAction {

        function __construct() {
            $this->replaceAutofillDataFromRequest();
            parent::__construct();
            $this->addValidateCallback('user_id', 'notEmpty');
            $this->addValidateCallback('skin_type_id', 'notEmpty');
        }
        ...
        public function replaceAutofillDataFromRequest() {
            ...
            $_REQUEST['skin_type_id'] = $_REQUEST['skin_type_id_autofill_id'];
            unset($_REQUEST['skin_type_id_autofill_id']);
        }
