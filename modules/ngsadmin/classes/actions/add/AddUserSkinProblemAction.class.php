...
use ngsadmin\managers\UserManager;
    ...
    class AddUserSkinProblemAction extends TableAddAbstractAction {

        function __construct() {
            $this->replaceAutofillDataFromRequest();
            parent::__construct();
            $this->addValidateCallback('user_id', 'notEmpty');
             $this->addValidateCallback('skin_problem_id', 'notEmpty');
        }
          ...
          public function replaceAutofillDataFromRequest() {
            ...
            $_REQUEST['skin_problem_id'] = $_REQUEST['skin_problem_id_autofill_id'];
            unset($_REQUEST['skin_problem_id_autofill_id']);
        }
