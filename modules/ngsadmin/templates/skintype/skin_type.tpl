...
<div class="table-wrapper" style="margin-top: 50px">
  <div class="table-content">
    <div id="f_orderingBox" class="table-row">
      ...
      <div class="table-content-title table-current-content">
        <a href="javascript:void(0)" data-ngs-sort-field="name" class="f_sorting"> Name </a>
      </div>
      <div class="table-content-title table-current-content">
        <a href="javascript:void(0)" data-ngs-sort-field="description" class="f_sorting"> Description </a>
      </div>
      <div class="table-content-title table-current-content">
