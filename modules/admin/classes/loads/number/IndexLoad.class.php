...
namespace admin\loads\number {
    ...
    class IndexLoad extends ModeratorLoad {
        ...
        public function getDefaultLoads() {
            $loads = array();
            $loads["area"]["action"] = "admin.loads.number.area_selection";
            $loads["area"]["args"] = array();
            $loads["add_edit"]["action"] = "admin.loads.number.add_edit";
            $loads["add_edit"]["args"] = array();
            $loads["list"]["action"] = "admin.loads.number.list";
            $loads["list"]["args"] = array();
            return $loads;
        }

        public function getTemplate() {
            return NGS()->getTemplateDir() . "/number/index.tpl";
        }
